...
//     g_provider,
//     "MyTestProvider",
//     (0xb3864c38, 0x4273, 0x58c5, 0x54, 0x5b, 0x8b, 0x36, 0x08, 0x34, 0x34,
//     0x71));
// TRACELOGGING_DEFINE_PROVIDER(
//     g_providerKeywords,
...
// void RunConsumerTraceLogging(LttngConsume::LttngConsumer& consumer, int&
// renderCount)
// {
...
//         // REQUIRE(jsonBuilder.count(itr) == 1);
...
// //         g_provider,
// //         "MyTestEvent",
// //         TraceLoggingCountedString(val.c_str(), 1, "MyString"));
...
//         g_providerKeywords,
//         "NoKeywords",
//         TraceLoggingCountedString(str.data(), str.size(), "StrName"));
//     TraceLoggingWrite(
//         g_providerKeywords,
//         "RandomEventName2",
//         TraceLoggingCountedString(str.data(), str.size(), "StrName2"));
//     TraceLoggingWrite(
//         g_providerKeywords,
//         "ASDKFJASDKFJ",
//         TraceLoggingCountedString(str.data(), str.size(), "StrName3"));
//     // TraceLoggingWrite(
//     //     g_providerKeywords, "OneKeywordMinValue",
